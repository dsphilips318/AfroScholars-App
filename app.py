...
from model import feedback1
from model import feedback2
...
@app.route('/yoruba/lesson2/results', methods=['GET', 'POST'])
def lesson2_results():
    if request.method == 'GET':
        return "You are getting the results page"
    if request.method == 'POST':
        ...
        return render_template('yoruba-lesson2_copy/results.html', props=props)
